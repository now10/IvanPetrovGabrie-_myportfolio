...
const projects = [
    {
        ...
        badge: 'iOS • Android',
        gameUrl: 'https://0908e881-5d9e-4d43-9f2b-804fdb26c5f2-00-1k70vj9b28rqi.picard.replit.dev/'
    },
    {
        ...
        description: '3D open-world driving with realistic physics, AI traffic, drifting, and 4 camera angles. Built with React Three Fiber.',
        tags: ['Three.js', 'WebGL', 'Physics', 'React'],
        badge: 'WebGL • 3D',
        gameUrl: 'https://d89752c8-c350-4b63-a89a-79ad61e7f000-00-23ouew19ry8y5.riker.replit.dev/'
    },
    {
        id: 'word-mosaic',
        title: 'Word Mosaic',
...
const skills = [
    ...
    { name: 'Three.js / WebGL', percent: 82 }
];

// ==================== CONTACT LINKS DATA ====================
const contactLinks = [
    { icon: 'fab fa-linkedin', label: 'LinkedIn', value: 't.me/ErcoIvanOrionixL', url: '#' },
    { icon: 'fab fa-github', label: 'GitHub', value: 'myportfolio-ivanpetrovgabriel.onrender.com', url: '#' },
...
function renderProjects() {
    ...
    grid.innerHTML = projects.map(project => {
        ...
        const icon = project.id === 'driving-stimulation' ? 'fa-car' : 'fa-play';
        ...
        <div class="project-card" data-category="${project.category}">
            ...
            <div class="project-content">
                ...
                <button onclick="window.open('${project.gameUrl}', '_blank')" class="project-button">
                    <i class="fas ${icon} mr-2"></i>${project.id === 'driving-stimulation' ? 'Drive Now' : 'Play Demo'}
                </button>
            </div>
        </div>
    `}).join('');
...
window.openGameModal = function(gameId) {
    // Check if it's the driving game - open in new tab instead
    const project = projects.find(p => p.id === gameId);
    if (project && project.id === 'driving-stimulation') {
